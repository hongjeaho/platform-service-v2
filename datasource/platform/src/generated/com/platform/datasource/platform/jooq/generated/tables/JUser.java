...
import com.platform.datasource.platform.jooq.generated.tables.JUserRole.UserRolePath;
import com.platform.datasource.platform.jooq.generated.tables.JUserRoleMapping.UserRoleMappingPath;
...
public class JUser extends TableImpl<UserRecord> {
    ...
    /**
     * The column <code>store.user.user_email</code>. 사용자 이메일
     */
    public final TableField<UserRecord, String> USER_EMAIL = createField(DSL.name("user_email"), SQLDataType.VARCHAR(100), this, "사용자 이메일");

    /**
     * The column <code>store.user.user_name</code>. 사용자명
     */
    public final TableField<UserRecord, String> USER_NAME = createField(DSL.name("user_name"), SQLDataType.VARCHAR(30).nullable(false), this, "사용자명");

    /**
     * The column <code>store.user.user_id</code>. 사용자 아이디
     */
    public final TableField<UserRecord, String> USER_ID = createField(DSL.name("user_id"), SQLDataType.VARCHAR(30).nullable(false), this, "사용자 아이디");

    /**
     * The column <code>store.user.user_password</code>. 비밀번호
     */
    public final TableField<UserRecord, String> USER_PASSWORD = createField(DSL.name("user_password"), SQLDataType.VARCHAR(100).nullable(false), this, "비밀번호");
     ...
     */
    public final TableField<UserRecord, Long> UPDATED_BY = createField(DSL.name("updated_by"), SQLDataType.BIGINT, this, "수정자");

    /**
     * The column <code>store.user.updated_time</code>. 수정일
     */
    public final TableField<UserRecord, LocalDateTime> UPDATED_TIME = createField(DSL.name("updated_time"), SQLDataType.LOCALDATETIME(0), this, "수정일");
    ...
    private JUser(Name alias, Table<UserRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("사용자 테이블"), TableOptions.table(), where);
    }
    ...
    public List<UniqueKey<UserRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_USER_UK_USER_ID);
    }

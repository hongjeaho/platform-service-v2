...
import com.platform.datasource.platform.jooq.generated.tables.JUser.UserPath;
...
public class JUserRole extends TableImpl<UserRoleRecord> {
    ...
    /**
     * The column <code>store.user_role.user_role_name</code>. Role명
     */
    public final TableField<UserRoleRecord, String> USER_ROLE_NAME = createField(DSL.name("user_role_name"), SQLDataType.VARCHAR(100).nullable(false), this, "Role명");
     ...
     */
    public final TableField<UserRoleRecord, Long> UPDATED_BY = createField(DSL.name("updated_by"), SQLDataType.BIGINT, this, "수정자");

    /**
     * The column <code>store.user_role.updated_time</code>. 수정일
     */
    public final TableField<UserRoleRecord, LocalDateTime> UPDATED_TIME = createField(DSL.name("updated_time"), SQLDataType.LOCALDATETIME(0), this, "수정일");
    ...
    private JUserRole(Name alias, Table<UserRoleRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("사용자 권한 테이블"), TableOptions.table(), where);
    }
